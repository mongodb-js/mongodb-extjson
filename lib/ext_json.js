...
/**
 * serializes EJSON to JSON
 *
 * @param {EJSON} ejson_obj
 * @param {object} options
 * @return {object}
 */
function serialize(ejson_obj, options) {
  options = options | {};
  return JSON.parse(stringify(ejson_obj, options));
}

/**
 * deserializes JSON to EJSON
 *
 * @param {object} obj
 * @param {object} options
 * @return {EJSON}
 */
function deserialize(obj, options) {
  options = options | {};
  return parse(JSON.stringify(obj), options);
}
