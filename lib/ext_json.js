...
/**
 * serializes BSON object to EJSON object
 *
 * @param {object} bson object of binary data (BSON type)
 * @param {object} options optional object with settings to be used in EJSON stringify function
 * @return {object} object of string data (EJSON type)
 */
...
/**
 * deserializes EJSON object to BSON object
 *
 * @param {object} ejson object of string data (EJSON type)
 * @param {object} options optional object with settings to be used in EJSON parse function
 * @return {object} object of binary data (BSON type)
 */
